...
namespace March2023.Pages
{
    public class EmployeePage : CommonDriver
    {
        public void CreateEmployee()
        {
            ...
            Assert.That(latestCreated.Text == "dhsrgrshrs", "Employee could not be created");
        }
